    ...
    <div className="w-full max-w-md bg-white rounded-3xl shadow-xl overflow-hidden">
      ...
      <div className="p-8">
        ...
        <button
          ...
          disabled={loading}
          className="w-full bg-white border border-gray-200 text-gray-700 font-bold py-3 rounded-xl hover:bg-gray-50 transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
        >
